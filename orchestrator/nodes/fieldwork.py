...
def _write_xlsx_workpaper(
    ...
    ws8 = wb.add_worksheet("Review notes")
    ws8.write_row(
        0, 0,
    ...
    for r, note in enumerate(review_notes, start=1):
        ...
        _write_str(ws8, r, 0, note.get("body"))
        _write_str(ws8, r, 1, target)
        _write_str(ws8, r, 2, note.get("raised_by"))
        _write_str(ws8, r, 3, note.get("raised_role"))
        _write_str(ws8, r, 4, note.get("raised_at"))
        _write_str(ws8, r, 5, note.get("state"))
        _write_str(ws8, r, 6, note.get("response"))
        _write_str(ws8, r, 7, note.get("responded_by"))
        _write_str(ws8, r, 8, note.get("responded_at"))
        _write_str(ws8, r, 9, note.get("cleared_by"))
        _write_str(ws8, r, 10, note.get("cleared_role"))
        _write_str(ws8, r, 11, note.get("cleared_at"))
    _write_str(ws8, len(review_notes) + 2, 0, footer)
