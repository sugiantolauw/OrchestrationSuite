...
def _raise_typed(endpoint: str, exc: Exception) -> None:
    ...
    # transient, retried once by LLMGateway like any other transport failure.
    raise TransientModelError(endpoint, message) from exc
