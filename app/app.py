...
from src import actions_page, run_setup, run_status, runs_page, skills_page, trace_page, workspace_tne  # noqa: E402
...
skills_page.register_callbacks(app)
actions_page.register_callbacks(app)
